                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="slider-inverse mt-sm ml-md">
                                    <input class="js-slider" id="slider-ex5" data-slider-id='ex5Slider' type="text" data-slider-min="{{ round(1000 / $token->currentStage()->price) }}" data-slider-max="{{ round($token->available_tokens > 1000000 ? 1000000 : $token->available_tokens / $token->currentStage()->price) }}"
