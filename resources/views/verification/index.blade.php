    ...
    <div class="single-widget-container mb-lg" style="margin-top: -390px;">
            <section class="widget login-widget">
                ...
                <div class="body">
                    ...
                    <form class="no-margin" action="{{ route('verification.verify') }}" method="POST" data-parsley-validate>
                        @csrf
                        <fieldset>
                            <div class="form-group mt-sm">
                                ...
                                <div>
                                    <select class="selectpicker" data-style="btn-default"
                                            data-width="full" id="method" name="method">
                            ...
                            <div class="form-group">
                                ...
                                <input id="first_name" type="text" class="form-control input-lg input-transparent" name="first_name" value="{{ old('first_name', $user->first_name) }}" minlength="1" placeholder="First Name" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="last_name">Last Name</label>
                                <input id="last_name" type="text" class="form-control input-lg input-transparent" name="last_name" value="{{ old('last_name', $user->last_name) }}" minlength="1" placeholder="Last Name" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="exp">Day of Birth</label>
                                <div class="input-group">
                                    <input id="dob" class="form-control input-lg input-transparent date-picker" type="text" name="dob" required="required" value="{{ old('dob', $user->dob) }}" placeholder="Day of Birth">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-block btn-lg btn-success">
                                <small>Go to Verify</small>
                            </button>
                            <a class="forgot" href="{{ route('logout') }}"
            ...
            <p class="error-help mt-lg text-center">
