                    ...
                    <form class="no-margin" action="{{ route('register') }}" method="POST" data-parsley-validate>
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input id="first_name" type="text" class="form-control input-lg input-transparent {{ $errors->has('first_name') ? ' parsley-error' : '' }}" name="first_name" value="{{ old('name') }}" minlength="1" placeholder="First Name" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="last_name" >Last Name</label>
                                <input id="last_name" type="text" class="form-control input-lg input-transparent {{ $errors->has('last_name') ? ' parsley-error' : '' }}" name="last_name" value="{{ old('name') }}" minlength="1" placeholder="Last Name" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="exp">Day of Birth</label>
                                <div class="input-group">
                                    <input id="dob" class="form-control input-lg input-transparent date-picker" type="text" name="dob" required="required" placeholder="Day of Birth">
